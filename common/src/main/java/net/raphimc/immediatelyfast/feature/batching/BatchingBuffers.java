...
public class BatchingBuffers {
    ...
    public static VertexConsumerProvider.Immediate beginHudBatching(final DrawContext drawContext) {
        drawContext.draw();
        final VertexConsumerProvider.Immediate prev = drawContext.vertexConsumers;
        drawContext.vertexConsumers = getHudBatchingVertexConsumers();
        isHudBatching = true;
    ...
    public static void endHudBatching(final DrawContext drawContext, final VertexConsumerProvider.Immediate prev) {
        drawContext.draw();
        drawContext.vertexConsumers = prev;
        isHudBatching = false;
    }
